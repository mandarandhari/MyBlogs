                                    ...
                                    <tr>
                                        <td class="bg_white email-section">
                                            <div class="heading-section" style="text-align: center; padding: 0 30px;">
                                                <h2>Hey There!</h2>
                                                <p>You have requested to change your account password. Please go to the link given below:</p>
                                                <p><a href="{{ url('reset-password?token='.$token) }}" style="word-break: break-word;">{{ url('reset-password?token='.$token) }}</a></p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
